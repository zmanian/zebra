...
- a block-interval variance source; the pure controller now derives a
  ...
  guardrail, while production still needs the exact target-spacing source and
  any stricter calibrated timestamp policy
