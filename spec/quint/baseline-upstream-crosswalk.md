...
| Nondeterministic faulty message injection in `Init` | `InitWithFaultyEvidence`, `CrosslinkBaselineFaultyInitTinyModel`, `CrosslinkBaselineFaultyInitForkingModel` | Partial | Covered in tiny and bounded forking harnesses; not lifted unbounded into all parameterized baseline instances. |
...
3. Make faulty proposal, prevote, and precommit injection usable in larger
