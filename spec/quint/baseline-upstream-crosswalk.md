...
| Faulty init symbolic checking | Tiny full-powerset faulty init plus bounded forking faulty init for `n4_f1`, representative `n4_f2`/`n5_f2`, single-/pair-/triple-faulty full-domain `n4_f2` abstractions, and single-/pair-faulty full-domain `n5_f2` abstractions; full forking faulty init remains quick-check-only for `n4_f1`, `n4_f2`, `n5_f1`, `n5_f2`, and `n7_f2` | Partial |
...
2. Broaden the tractable symbolic shape for faulty proposal, prevote, and
   ...
   full-domain `n4_f2` harnesses, and single-/pair-faulty full-domain
   `n5_f2` harnesses. The
