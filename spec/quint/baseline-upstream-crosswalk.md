...
| Full PoW environment checking | Fixed fork switch, long-reorg, and fixed-sigma sampling fixtures | Partial |
...
7. Replace the remaining hand-authored fork-switch and long-reorg fixtures with
   generated bounded PoW schedules and a simple stochastic or adversarial
