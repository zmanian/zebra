...
2. Broaden the tractable symbolic shape for faulty proposal, prevote, and
   ...
   full-domain `n4_f2` harnesses, and single-/pair-/triple-faulty full-domain
   `n5_f2` harnesses. The
