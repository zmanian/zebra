...
| Faulty init symbolic checking | Tiny full-powerset faulty init plus bounded forking faulty init for `n4_f1` and representative `n5_f2`; full forking faulty init remains quick-check-only for `n4_f1`, `n4_f2`, `n5_f1`, `n5_f2`, and `n7_f2` | Partial |
...
3. Broaden the tractable symbolic shape for faulty proposal, prevote, and
   ...
   `n5_f2` harnesses. The fixed-sigma/forking `n4_f1`, `n4_f2`, `n5_f1`,
   `n5_f2`, and `n7_f2` surfaces now have full-powerset quick coverage.
