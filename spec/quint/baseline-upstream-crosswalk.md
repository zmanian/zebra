...
| Faulty init symbolic checking | Tiny full-powerset faulty init plus bounded forking faulty init; full forking faulty init remains quick-check-only for `n4_f1`, `n5_f1`, `n5_f2`, and `n7_f2` | Partial |
...
3. Make faulty proposal, prevote, and precommit injection usable in all larger
   ...
   and bounded harnesses. The fixed-sigma/forking `n4_f1`, `n5_f1`, `n5_f2`,
   and `n7_f2` surfaces now have full-powerset quick coverage.
