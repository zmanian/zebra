...
- `CrosslinkBaselineAccountability.qnt`
  ...
  - adds single-/pair-/triple-faulty `n7_f2` symbolic harnesses that select one
    to three arbitrary faulty proposals, prevotes, and precommits from the
    larger full `n7_f2` faulty evidence domains
...
3. Add upstream-style faulty message injection.
   ...
   - The single-/pair-/triple-faulty `n4_f2` harnesses symbolically range over one
     ...
     single-/pair-/triple-faulty `n7_f2` harnesses range over the proper f=2
     boundary's full faulty-evidence domain at max depth 2;
...
1. Broaden upstream-style faulty message injection beyond the current shell
   ...
   - Single-/pair-/triple-faulty `n7_f2` harnesses now range over the proper
     f=2 boundary's full faulty-evidence domain by selecting one to three
     arbitrary faulty proposals, prevotes, and precommits at max depth 2.
